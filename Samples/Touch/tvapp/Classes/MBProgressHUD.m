...
- (void)layoutSubviews {
    ...
    CGSize size1 = [label.text sizeWithAttributes:
                   @{NSFontAttributeName: label.font}];
    
    // Values are fractional -- you should take the ceilf to get equivalent values
    CGSize labelSize = CGSizeMake(ceilf(size.width), ceilf(size1.height));
    ...
    CGSize size2 = [label.text sizeWithAttributes:
                    @{NSFontAttributeName: label.font}];
    
    // Values are fractional -- you should take the ceilf to get equivalent values
    CGSize detailsLabelSize = CGSizeMake(ceilf(size2.width), ceilf(size2.height));
