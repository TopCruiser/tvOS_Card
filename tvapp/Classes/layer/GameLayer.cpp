...
void GameLayer::showSettingLayer()
{
    ...
    //Sequence *_sequence  =  CCSequence::create(_easein, CCCallFuncND::create(this, callfuncND_selector(GameLayer::doneSettingAnimation), NULL), NULL);
    Sequence *_sequence  =  Sequence::create(_easein, CC_CALLBACK_2(GameLayer::doneSettingAnimation, this), NULL);
